...
/**
 * Almost same as unique.c
 * This version takes 1 ms more than unique.c to execute when it's 
 * test on [1,50].
 * 
 * On this versión it is not verified if x > 45. The only pourpose of this
 * file is if you want to check the correctness of the get_numbers function.
 */
